    ...
    <div class="col-md-5">
      ...
      <form method="POST" action="{{ route('mypage') }}">
        ...
        <div class="form-group">
          ...
          <div class="collapse showeditUserName">
      ...
      <div class="d-flex justify-content-start">
        <form method="POST" action="{{ route('mypage.destroy) }}">
          ...
          <div class="modal fade" id="delete-uer-confirm-modal" data-backdrop="static" data-keyboad="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn dashboard-delete-link" data-bs-desmiss="moidal">キャンセル</button>
                  <button type="button" class="btn samuraimart-delete-submit-buttton">退会する</button>
                </div>
              </div>
            </div>
          </div>
