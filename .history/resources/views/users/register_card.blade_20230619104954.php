...
<main class="py-4 mb-5">
   ...
   <div class="d-flex justify-content-canter">
    <div class="container w-50">
      ...
      <form action="{{ route('mypage.token') }}" method="post">
       ...
       @else
        <script type="text/javascript" src="https//checkout.pay.jp/" class="paujp-button" data-key="{{ ENV('PAYJP_PUBLIC_KEY') }}" data-on-created="onCreated" data-text="カードを更新する" data-submit-text="カードを更新する"></script>
        @endif
      </form>
    </div>
  </div>
